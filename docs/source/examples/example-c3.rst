...
Afterwards, a :class:`~vcams.mask.shape.Circle` object (named ``circle_obj``) is created.
...
Then, a mask is created using the ``circle_func.func()`` method.
...
.. literalinclude:: /../../examples/ex_c3_single_shape.py

The final model looks like :numref:`ex_c3_single_shape`.
Note that elements in different sets are shown in different colors.

.. figure:: /images/ex_c3_single_shape.png
   :name: ex_c3_single_shape
   :align: center
