Example C-4: Randomly Distributed Second Phase (3D)
===================================================
This example, a 3D part is created in which a second phase is randomly distributed
in a background.
This is similar to :doc:`Example A-5 <example-a5>`, but is achieved more easily
using a Boolean Mask. Also, a 2D version is demonstrated in :doc:`Example C-3 <example-c3>`.
...
First, a 3D part with a shape of 100×100×100 voxels is created
...
.. literalinclude:: /../../examples/ex_c4_random_mask_3d.py

The final model looks like :numref:`ex_c4_random_mask_3d`.
Note that elements in different sets are shown in different colors.

.. figure:: /images/ex_c4_random_mask_3d.png
   :name: ex_c4_random_mask_3d
   :align: center
