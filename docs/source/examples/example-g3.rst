Example G-3: 2D Part with a Randomly Distributed Second Phase
=============================================================
...
.. figure:: /g-examples/ex_g3_random_2d_part_1.png
   :align: center
   :width: 75%

   The GUI's "Basic Model Information" tab for Example G-3.

.. figure:: /g-examples/ex_g3_random_2d_part_2.png
   :align: center
   :width: 75%

   The GUI's "Model Manipulations" tab for Example G-3.

.. figure:: /g-examples/ex_g3_random_2d_part_3.png
   :align: center
   :width: 75%

   The GUI's "Boundary Conditions" tab for Example G-3.

.. figure:: /g-examples/ex_g3_random_2d_part_4.png
   :align: center
   :width: 75%
...
:download:`It will look like this. </g-examples/ex_g3_random_2d_part.vcams>`