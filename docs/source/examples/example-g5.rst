Example G-5: Planar Composite (Circular Inclusions) I
=====================================================
...
This example mirrors :doc:`Example C-4 <example-c4>`.
...
In the case of this example, all circles have a material code of 2.
...
.. figure:: /g-examples/ex_g5_shape_array_2d_1_1.png
   :align: center
   :width: 75%

   The GUI's "Basic Model Information" tab for Example G-5.

.. figure:: /g-examples/ex_g5_shape_array_2d_1_2.png
   :align: center
   :width: 75%

   The GUI's "Model Manipulations" tab for Example G-5.

.. figure:: /g-examples/ex_g5_shape_array_2d_1_3.png
   :align: center
   :width: 75%

   The GUI's "Boundary Conditions" tab for Example G-5.

.. figure:: /g-examples/ex_g5_shape_array_2d_1_4.png
   :align: center
   :width: 75%

   The GUI's "Output" tab for Example G-5.
...
:download:`It will look like this. </g-examples/ex_g5_shape_array_2d_1.vcams>`

The final model looks like :numref:`ex_g5_shape_array_2d_1_0`.
...
.. figure:: /g-examples/ex_g5_shape_array_2d_1_0.png
   :name: ex_g5_shape_array_2d_1_0
   :align: center
   :alt: Final model of Example G-5. Different materials are shown in different colors.

   Final model of Example G-5. Different materials are shown in different colors.