"""Script for Example 8: Manipulation of the Structure Using Masks (II)"""
...
part = VoxelPart(size=(50, 75, 100), base_material=0,
                 ...
                 name='Ex8 Mask Manipulation 2',
                 description='Example 8: A 50*75*100 part created using a random boolean mask.',
                 log_debug=True)
...
# Output the part.
part.output_abaqus_inp(file_name='ex8_mask_manipulation_2',
