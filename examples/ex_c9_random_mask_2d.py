"""Script for Example C-9: Random Mask 2D"""
...
part = VoxelPart(size=(100, 100), base_material=1,
                 ...
                 name='Ex C-9 Random Mask 2D Part',
                 description='Example C-9: A 100*100 part with a random distribution of elements.',
                 log_debug=True)
...
# Output the part.
part.output_abaqus_inp(file_name='ex_c9_random_mask_2d',
