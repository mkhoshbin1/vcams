...
# Create the part.
part = VoxelPart(size=(50, 50, 50), base_material=0, voxel_size=(1, 1, 1), name='Ex C-3 Single Shape',
...
ellipse_obj = mask.shape.Ellipsoid(id=0, xc=20, yc=20, zc=20, a=5, b=12, c=20, alpha=20, beta=0, gamma=0)
