...
Then, a function is defined which describes a circle,
...
# Output the part.
part.output_abaqus_inp(file_name='function_part_2d', folder_path=results_path,
